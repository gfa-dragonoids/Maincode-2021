...
public class MasterAuto2021 extends LinearOpMode {
   ...
   * <p>A basic strafe function, that strafes the robot.  I am unsure if a positive direction input will result in left or right motion, so please experiment and upade the documentation, or I may do so myself at a later date.</p>
   * @param distance The distance that the robot will strafe.
   * @param pwr The power that the robot will use.
   */
